...
assert.deepEqual(listed.tools.map(t=>t.name).sort(),["audit_paid_search","budget_allocator","build_growth_bet","connection_status","content_strategy","create_campaign_asset","design_paid_experiment","find_seo_opportunities","growth_snapshot","opportunity_radar","paid_performance_review","weekly_growth_brief"]);
const calls=[
