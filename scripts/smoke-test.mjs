...
assert.deepEqual(listed.tools.map(t=>t.name).sort(),["action_audit_history","action_permission_status","approve_marketing_action","audit_paid_search","brand_vs_nonbrand_search","budget_allocator","build_dashboard","build_dashboard_chart","build_email_campaign_plan","build_growth_bet","build_paid_campaign_plan","campaign_to_pipeline_report","channel_health_scorecard","connection_status","connector_catalog","content_decay_monitor","content_strategy","create_campaign_asset","derive_growth_strategy","derive_marketing_strategy","design_paid_experiment","diagnose_setup","execute_approved_action","executive_growth_review","experiment_review","find_seo_opportunities","ga4_acquisition_report","generic_crm_csv_report","google_ads_report","google_search_console_report","growth_snapshot","hubspot_funnel_report","keyword_opportunity_research","landing_page_opportunity_report","live_opportunity_radar","measurement_quality_audit","opportunity_radar","paid_performance_review","preview_marketing_action","recommend_next_growth_bet","revoke_action_approval","salesforce_funnel_report","save_evidence_snapshot","snapshot_history","weekly_growth_brief"]);
const calls=[
