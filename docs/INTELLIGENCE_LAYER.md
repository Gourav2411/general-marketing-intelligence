...
As of v1.11.0, the first two governed batches contain 32 fully enriched cases across seven markets; 13 cases (40.6%) are failed or mixed. Batch two deliberately strengthens India and APAC, B2B SaaS, pricing and promotions, product launches, lifecycle and email, SEO, media allocation and documented PR-crisis coverage. Sources include company filings and reports, regulator records and first-party platform case studies. Claims remain conservatively graded, and the 218-case gap to the first editorial milestone is reported rather than filled with generated or weakly sourced records.
