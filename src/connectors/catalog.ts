...
export const connectorCatalog:CatalogEntry[]=[
 ...
 {id:"generic_crm_api",label:"Generic CRM HTTPS JSON API",status:"IMPLEMENTED",mode:"read-only",category:"CRM"},
 {id:"paid_media_csv",label:"Generic paid-media CSV",status:"IMPLEMENTED",mode:"read-only",category:"paid media"},
 {id:"meta_ads",label:"Meta Ads",status:"IMPLEMENTED",mode:"read-only",category:"paid media"},
 {id:"linkedin_ads",label:"LinkedIn Ads",status:"IMPLEMENTED",mode:"read-only",category:"paid media"},
