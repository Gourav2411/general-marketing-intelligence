...
export const chartTypes=["bar","horizontal_bar","line","area","donut","table","kpi"] as const;
export const querySchema=z.object({
  dataset:z.enum(["search","ads","conversions"]),
...
export type DashboardPoint={label:string;value:number;rows:number};
