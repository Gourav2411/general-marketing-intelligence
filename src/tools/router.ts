export const toolFamilies={
 executive:["executive_growth_review","channel_health_scorecard","recommend_next_growth_bet","weekly_growth_brief","create_marketing_decision","record_marketing_outcome","inspect_account_learning"],
 ...
 governance:["connection_status","diagnose_setup","action_permission_status","preview_hubspot_task_draft","action_audit_history","retrieve_marketing_precedents"],
